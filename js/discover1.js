...
//				var i = e.index;
//				if(i == 0) {
//					var itemname = id + "img-"+'Img' +imgId+ + imgkey; //429img-F_ZDDZZ  
//					
...
//			var divid = conf.id;
//			var imgNum = $('.fxfbi_image .imgs').length;
...
//			var itemname = id + "img-"+'Img' +name+ divid; //429img-
//			var itemvalue = plus.storage.getItem(itemname);
//			if(itemvalue == null) {
...
//					mui.toast('请完整填写地址');
//					return false;
//				}else if(cat_id1==''||ton==''||cube==''||car_cat==''||spec_id==''||load_time==''){
